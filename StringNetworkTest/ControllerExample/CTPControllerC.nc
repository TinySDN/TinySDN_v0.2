...
uint16_t targetA = 2;
  ...
  event void Boot.booted() {
    ...
    control_flow_table[0].destination = 1;
    control_flow_table[0].target = 2;
    control_flow_table[0].next_hop = 2;

    control_flow_table[1].destination = 1;
    control_flow_table[1].target = 3;
    control_flow_table[1].next_hop = 2;

    control_flow_table[2].destination = 1;
    control_flow_table[2].target = 4;
    control_flow_table[2].next_hop = 2;

    control_flow_table[3].destination = 1;
    control_flow_table[3].target = 5;
    control_flow_table[3].next_hop = 2;

    control_flow_table[4].destination = 2;
    control_flow_table[4].target = 3;
    control_flow_table[4].next_hop = 3;

    control_flow_table[5].destination = 2;
    control_flow_table[5].target = 4;
    control_flow_table[5].next_hop = 3;

    control_flow_table[6].destination = 2;
    control_flow_table[6].target = 5;
    control_flow_table[6].next_hop = 3;

    control_flow_table[7].destination = 3;
    control_flow_table[7].target = 4;
    control_flow_table[7].next_hop = 4;

    control_flow_table[8].destination = 3;
    control_flow_table[8].target = 5;
    control_flow_table[8].next_hop = 4;

    control_flow_table[9].destination = 4;
    control_flow_table[9].target = 5;
    control_flow_table[9].next_hop = 5;
    ...
    data_flow_table[3].destination = 2;
    data_flow_table[3].target = 2016;
    data_flow_table[3].next_hop = 1;
    data_flow_table[3].actionID = ACTION_FORWARD;

    data_flow_table[4].destination = 1;
    data_flow_table[4].target = 2016;
    data_flow_table[4].actionID = ACTION_RECEIVE;
...
/*
    ...
    printfflush();*/
      ...
      if(request_type == CONTROL_FLOW_REQUEST){
        ...
        if (call AMSend.send(1, &packetResponse, sizeof(tinysdn_data_flow_setup_t)) == SUCCESS) {
          locked = TRUE;
        }
